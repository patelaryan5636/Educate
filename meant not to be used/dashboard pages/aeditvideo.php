    ...
    <li class="nav-item dropdown has-arrow main-drop">
        ...
        <div class="dropdown-menu menu-drop-user">
            <div class="profilename">
                ...
                <hr class="m-0">
                <a class="dropdown-item" href="aprofile.php"> <i class="me-2" data-feather="user"></i> My
                    Profile</a>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" name="product_name" value="Default1">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Language</label>
                                        <select class="select" name="categorylist">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control">Hello Guys welcome to my channel</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <a href="videoslist.php" class="btn btn-cancel">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
